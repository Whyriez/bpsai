...
const ExportableTable = ({ children }) => {
  ...
  return (
    ...
    >
      {/* Header Toolbar */}
      <div className="flex items-center justify-between gap-3 px-3.5 py-2 bg-slate-50/90 dark:bg-slate-700/50 border-b border-slate-200 dark:border-slate-700">
        <div className="flex items-center gap-2 min-w-0 flex-1 text-xs font-semibold text-slate-800 dark:text-slate-200">
          <svg
